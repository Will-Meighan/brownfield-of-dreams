...
User.create!(email: 'will@example.com', first_name: 'Will', last_name: 'Meighan', password:  "password", role: :default, token: ENV['GITHUB_TEST_TOKEN_2'], username: "Will-Meighan")
